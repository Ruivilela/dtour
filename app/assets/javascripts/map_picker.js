if(window.location.pathname == '/'){
  document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('search_location_submit').addEventListener('click',redirect);
  });
}
// redirect
function redirect(){
  window.location = 'search/result&' + document.getElementById('search_location_input').value;
}
// var map;
// var markers = [];
//
